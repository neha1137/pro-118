$(document).ready(function(){
    ...
    $('#displaydate').text('Date : ' + current_date)
    ...
    let product = {"product":$("product").val()}
    let emotion = {"emotion":$("emotion").val()
    }
    let emoji_url = "C:/Users/chair/Downloads/PRO-C118-Project-Boilerplate-main/PRO-C118-Project-Boilerplate-main/static/assets/emoticons"
