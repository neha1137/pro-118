...
def save():
    ...
    sentiment = request.json.get('text')
    ...
    with open("C:/Users/chair/Downloads/PRO-C118-Project-Boilerplate-main/PRO-C118-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv","a" )as f:
                f.write(data_entry)   
